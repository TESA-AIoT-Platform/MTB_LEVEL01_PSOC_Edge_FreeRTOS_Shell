...
#if !defined(PSE846GPS2DBZC4)
#error "Unexpected MPN; expected DEVICE:=PSE846GPS2DBZC4. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
#endif /* !defined(PSE846GPS2DBZC4) */
#endif /* defined(CY_SUPPORTS_DEVICE_VALIDATION) */

#if defined(CY_SUPPORTS_COMPLETE_DEVICE_VALIDATION)
#if !defined(PSE846GPS2DBZC4)
#error "Unexpected MPN; expected DEVICE:=PSE846GPS2DBZC4, ADDITIONAL_DEVICES:=CYW55513IUBG. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
#endif /* !defined(PSE846GPS2DBZC4) */
